    ...
    return (
        <Nav className='justify-content-center mb-4'>
            <NavItem>
                ...
                </LinkContainer>):<NavLink disabled>Sign In</NavLink>}
            </NavItem>

            <NavItem>
                {step2 ? (<LinkContainer to='/shipping'>
                    <NavLink>Shipping</NavLink>
                </LinkContainer>):<NavLink disabled>Shipping</NavLink>}
            </NavItem>

            <NavItem>
                {step3 ? (<LinkContainer to='/payment'>
                    <NavLink>Payment</NavLink>
                </LinkContainer>):<NavLink disabled>Payment</NavLink>}
            </NavItem>

            <NavItem>
                {step4 ? (<LinkContainer to='/placeorder'>
                    <NavLink>Place Order</NavLink>
                </LinkContainer>):<NavLink disabled>Place Order</NavLink>}
            </NavItem>
        </Nav>
    )
}
